...
<div class="signup-container">
    ...
    <form method="post" id="doctorSignupForm" onsubmit="return validateForm()">
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="required">BMDC Registration Number</label>
                <input type="text" name="bmdc" id="bmdc" required placeholder="BMDCXXXX">
                <div class="validation-error" id="bmdcError">BMDC number is required</div>
            </div>
            <div class="form-group">
                <label class="required">National ID (NID)</label>
                <input type="text" name="nid" id="nid" required placeholder="XXXXXXXXXXXXX">
                <div class="validation-error" id="nidError">NID is required</div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" id="address" required placeholder="Full clinic address">
            <div class="validation-error" id="addressError">Address is required</div>
        </div>

        <div class="form-group">
            <label class="required">Chamber Location</label>
            <input type="text" name="chamber" id="chamber" required placeholder="Building name, floor, room number">
            <div class="validation-error" id="chamberError">Chamber location is required</div>
        </div>

        <!-- Availability -->
        <div class="form-group">
            <label class="required">Available Days</label>
            <div class="checkbox-group">
            ...
            <div class="validation-error" id="daysError">Please select at least one day</div>
        </div>

        <div class="form-row">
            <div class="form-group">
                <label class="required">Available Time From</label>
                <input type="time" name="time_from" id="time_from" required>
                <div class="validation-error" id="timeFromError">Start time is required</div>
            </div>
            <div class="form-group">
                <label class="required">Available Time To</label>
                <input type="time" name="time_to" id="time_to" required>
                <div class="validation-error" id="timeToError">End time is required</div>
            </div>
        </div>
